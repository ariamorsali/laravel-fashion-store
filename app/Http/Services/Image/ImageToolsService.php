...
class ImageToolsService  // مدیریت و پردازش تصاویر
{

    protected $image;
    protected $exclusiveDirectory;  // دایرکتوری اختصاصی
    ...
    {
        $this->exclusiveDirectory = trim($exclusiveDirectory, '/\\');  // حذف کاراکترهای اضافی
    }
