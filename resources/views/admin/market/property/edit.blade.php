...
@section('content')
    <section class="container-fluid px-0">
        ...
        <section class="main-body-container">
            <section>
                <h3 class="mt-2">Edit Attribute</h3>
            </section>
            ...
            <section>
                <form action="{{ route('admin.market.property.update', $productAttribute) }}" method="post">
                    @csrf
                    @method('put')
                    <section class="row">
                                ...
                                <select name="category_id" class="form-control form-control-sm" id="category_id"
                                    ...
                                    @foreach ($productCategories as $category)
                                        <option value="{{ $category->id }}"
                                            @if (old('category_id', $productAttribute->category_id) == $category->id) selected @endif>
                        ...
                        <section class="col-12 my-2 d-flex justify-content-end">
