...
@section('head-tag')
    <title>Edit Common Discounts</title>
    ...
    <section class="container-fluid px-0">
        <nav style="background-color: #eee; height: 2.25rem" class="my-4 rounded ps-2" aria-label="breadcrumb">
            <ol class="breadcrumb p-1 ">
                ...
                <li class="breadcrumb-item active">Edit Common Discounts</li>
            </ol>
        </nav>
        <section class="main-body-container">
            <section>
                <h3 class="mt-2">Edit Common Discounts</h3>
            </section>
            ...
            <section>
                <form action="{{ route('admin.market.discount.common_discount.update', $common_discount) }}" method="post">
                    @csrf
                    @method('put')
                    <section class="row">
                        <section class="col-12 col-md-6 my-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="percentage" id="percentage"
                                    value="{{ old('percentage', $common_discount->percentage) }}">
                            </div>
                            @error('percentage')
                        ...
                        <section class="col-12 col-md-6 my-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="title" id="title"
                                    placeholder="The title of the occasion"
                                    value="{{ old('title', $common_discount->title) }}">
                            </div>
                            @error('title')
                                <div class="text-danger" style="margin-top: 9px; font-size: 12px; font-weight: 400;">
                                    <strong>{{ $message }}</strong>
                        ...
                        <section class="col-12 col-md-6 my-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" id="start_date" class="form-control form-control-sm"
                                    value="{{ old('start_date', $common_discount->start_date) }}"
                        ...
                        <section class="col-12 col-md-6 my-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="end_date" id="end_date" class="form-control form-control-sm"
                                    value="{{ old('end_date', $common_discount->end_date) }}" placeholder="Select date">
                                @error('end_date')
                                    <div class="text-danger mt-2" style="font-size: 12px;">
                                        <strong>{{ $message }}</strong>
                                    </div>
                        ...
                        <section class="col-12 my-3">
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control form-control-sm" id="status">
                                    <option value="0" @if (old('status', $common_discount->status) == 0) selected @endif>inactive
                                    </option>
                                    <option value="1" @if (old('status', $common_discount->status) == 1 && $common_discount->end_date && now() <= $common_discount->end_date) selected @endif>active</option>
                                    <option value="2" @if (now() > $common_discount->end_date) selected @endif>expired
                                    </option>
                                </select>
                            </div>
                            @error('status')
