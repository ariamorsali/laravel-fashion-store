                        ...
                        <section class="col-12 col-md-6 my-3">
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control form-control-sm" id="type">
                                    <option value="0" @if (old('type') == 0) selected @endif>common
                                    </option>
                                    <option value="1" @if (old('type') == 1) selected @endif>private
                                    </option>
                                </select>
                            </div>
                            @error('type')
                        ...
                        <section class="col-12 col-md-6 my-3">
                            <div class="form-group">
                                ...
                                <select name="amount_type" class="form-control form-control-sm" id="amount_type">
                                    <option value="0" @if (old('amount_type') == 0) selected @endif>percentage
                                    </option>
                                    <option value="1" @if (old('amount_type') == 1) selected @endif>numerical
                                    </option>
                                </select>
                            </div>
                            @error('amount_type')
